...
export const PROMPTS = {
  ...
  sceneWrite: [
    ...
    [
      ...
      'person in the same clothes. pose is "in bed" for one person lying',
      'or sitting up in bed (a patient, someone asleep), else "standing".',
    ...
    [
      ...
      'Fields: ref, state and pose for character, figure, count, pose and',
      'state for person; they are null on every other kind.',
    ].join(' '),
    [
