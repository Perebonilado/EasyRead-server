...
export const PROMPTS = {
  ...
  sceneWrite: [
    ...
    NO_INVENTION,
    [
      "When the message gives teacher's notes, the page is one part of a",
      'lesson that runs across the chapter, and the notes were written by',
      'a teacher who read all of it. Follow them: teach toward the goal,',
      'move through the small ideas in their order, each with its own',
      'change of the stage showing what the notes say to show, show the',
      'lists item by item, name the mistake to avoid, put the check',
      'question, and lead toward the next page at the end. A page that',
      'carries on from the one before is the same lesson going on: no',
      'greeting, no title-like opening, no introducing the topic again;',
      'pick up where it stopped, with the things it left on the stage kept',
      'under their ids. Where a page builds on an earlier idea, ask the',
      'learner to recall it before reminding them. Never use a term the',
      'notes say the chapter teaches later. The page stays the source of',
      'every fact; the notes only say how to teach it.',
    ].join(' '),
    [
    ...
    [
      ...
      'Only a human being is a "person". A computer, a program, or a role a',
      ...
      'or the box it runs on, however human its name sounds; what the',
      "teacher's notes say each thing is, and how it is drawn, wins.",
      ...
      'or title: for a term the voice names, and for each item of a list',
      'the voice reads out when there is no picture for it. Otherwise the',
      'voice carries the words and the stage carries the pictures.',
    ...
    [
      'Keep the picture moving with the voice, so the learner is carried',
      'along. An idea the voice stays on for a while has smaller ideas',
      'inside it: each sentence, or each clause that says something new.',
      'Give every small idea one change the learner can see, on its first',
      'words: a new thing, a part pointed at, a state shown, a keyword, a',
      'zoom. That is a change about every six to ten seconds, fifteen to',
      'twenty-five spoken words, and never thirty words with nothing new.',
      'The first step is on the first words of the first sentence. Build',
      'the stage up as things are named and send off what the voice has',
      'finished with; the stage itself (what is shown, or how it is laid',
      'out) changes every sentence or two, a thing at a time, so the',
      'picture is built up as the voice goes: never one picture held while',
      'several sentences pass. When the voice',
      'lists things ("storage, compute and the network"), each comes on the',
      'stage as it is named, one step each: a small drawing, or a keyword',
      'card, building up a row. While the voice stays on one thing, keep it and',
      'change how it is seen: point at the part being explained, show its',
      'next state, zoom in on the detail. One change at a time: never two',
      'on the same few words, except a new thing and a point at it, so the',
      'learner is never lost among moving things. At most four things on',
      'stage at once, five in a row or a hub. A thing the voice is still',
      'talking about stays on stage.',
    ].join(' '),
    [
  ...
  sceneScreenplay: [
    ...
    [
      ...
      'kinds. "line": a character speaks. who is their id: where the book',
      'does not say who, work it out from what the line says and what the',
      'story says each one does (the one who has the rope says "I will tie',
      'it to the rope"), and from how the page before ends, never by',
      'taking turns. to is whom they',
      ...
      '"afraid", "surprised", "thinking", "pain"): give every line the',
      'face its words are said with, so the face changes as the feeling',
      'does (a plea is sad, a rebuke angry, a question thinking, good news',
      'happy); null only when it is the face they already have;',
    ...
    [
      ...
      '"shrug", "lean-in"; what they do with a thing on the stage, bread, a',
      'cup, a fish, a bowl, a jar: "take", "raise" (lift it up, bless it,',
      'give thanks), "break", "give" (to whom), "eat", "drink", "dip", "put"',
      '(set it down), with say naming the thing; or "still" (only a face or',
      'a thing changes). to',
    ...
    [
      ...
      'But what the book tells people doing with food and things, taking,',
      'blessing, breaking, giving, eating, drinking, dipping, keep as',
      'narration in the book\'s own words ("Jesus took bread, blessed it,',
      'broke it and gave it to the disciples"): the stage acts each of',
      'those on its word, and the food on the table is seen.',
    ...
    [
      ...
      'fisherman) is kind "person" with a figure. Bread, a cup, fish, a',
      "bowl, a jar, a plate, a basket, fruit, a lamp are the stage's own",
      'props: never cast them; they are on the table when the page names',
      'them, and handled by the "take", "raise", "break", "give", "eat",',
      '"drink", "dip" and "put" actions (a "give" with to the one who gets',
      'it). A thing the story needs',
  ...
  /** A chapter read whole, before any video: the teacher's notes each page's video is written from. */
  sceneNotes: [
    [
      'You are an experienced teacher preparing a lesson. You are given one',
      'chapter of a document, page by page, as plain notes. Each page will',
      'become a short animated explainer video: a friendly voice teaches',
      'while pictures, keyword cards and lists come onto a stage. Before any',
      "video is written, read the whole chapter and write the teacher's",
      'notes, so the videos play as one lesson that flows from page to page',
      'rather than as pages each starting afresh.',
    ].join(' '),
    [
      'thread is the one question the chapter answers, in a sentence.',
      'example is the concrete example the chapter keeps coming back to (a',
      "photo-sharing app, one patient, one family's budget), or null.",
      'diagram is the picture the chapter builds up page by page (the',
      'system, gaining a part at a time; the heart, chamber by chamber), or',
      'null.',
    ].join(' '),
    [
      'pictures are the things the chapter keeps showing, each as it really',
      'is in this subject, so every page draws it truly and the same way. A',
      'picture is how a learner understands, and a wrong one teaches',
      "something false. name is the chapter's word for it; is says what it",
      'really is here, in a few words; draw says what to draw; person is true',
      'only for a human being. Words that name a person in everyday speech',
      'often name a machine or a program in a technical subject: in',
      'computing a client, a user agent, a server, a worker, a node, a host,',
      'a master or a replica, a producer or a consumer, a peer or an agent',
      'is software or a computer (draw the device or the box it runs on, a',
      'laptop and a phone showing the app, a server rack), while in law or',
      'business a client is a person. A user who is a human is a person.',
    ].join(' '),
    [
      'Give one entry for every page asked for, by its number. relation is',
      'how the page stands to the page before it: "continues" when it',
      'carries on the same idea (the same section, a list or an argument',
      'begun before, a sentence cut by the page break); "example" when it',
      'works an example of the idea before; "recap" when it sums up;',
      '"exercise" when it sets questions or tasks; "skip" only for a page',
      'with nothing to teach (a title page, contents, an index, references,',
      'acknowledgements, a blank page); "fresh" when it starts a new idea.',
      'Most pages inside a section continue it: a new heading is usually',
      'where a fresh page begins. evidence says why in under fifteen words',
      '("starts mid-list: limits four to six of six").',
    ].join(' '),
    [
      'goal completes "the learner can say ..." for the page, in one',
      'sentence. newHere lists the terms and ideas first taught on this',
      "page, in the page's own words, a term under the page that first",
      'explains it and no other. callback says what earlier idea the page',
      'builds on, with its page ("latency, page 12"), or null. points are',
      'the small ideas the page moves through, in order, three to eight for',
      'a full page, fewer for a short one, none for a skipped one: say is',
      'the gist of what the voice says for it (not a script); show is what',
      'the stage shows for it, in a few words, naming the thing, the list,',
      'the part of the diagram or the formula that comes on or changes',
      '("the database, beside the web server"; "the three kinds of cache,',
      'one by one"; "the arrow from user to CDN"); kind is "hook",',
      '"explain", "example", "list", "contrast", "pitfall", "check" or',
      '"recap". Each point is one change of the picture, so the stage keeps',
      'moving with the voice: never two ideas on one unchanged picture.',
    ].join(' '),
    [
      'lists are the lists on the page worth showing item by item as they',
      'are said ("the three kinds of cache: memory, disk, CDN"). pitfall is',
      'the mistake learners make here, or null. check is one question the',
      'learner can answer after the page, or null. handoff is what the page',
      'leaves open for the next one, as a question or a turn ("but what',
      'happens when the one database fails?"), or null. endsOn is what',
      'stands on the stage as the page ends, in a few names, so the next',
      'page can open where this one stopped; a page that continues opens on',
      'the endsOn of the page before it and builds from there.',
    ].join(' '),
    'Plan only from what the pages say: add no facts, and never move an idea to a page that does not teach it.',
  ].join('\n\n'),
  ...
  sceneStory: [
    ...
    'pages: one for each page of the stretch. page is its number as',
    'marked. story is false for a page that is not the story itself: a',
    "title or credits page, a publisher's letter or notice, contents, the",
    'blurb from the back cover, an advert; such a page has no one present',
    'and no place. story is true for every page the story is told on, its',
    'opening too, however little happens there. summary is one plain',
    'sentence of what happens,',
    ...
    "only mentioned is not present. A character's place is where they are",
    'on a page where its people are apart in two places at once, calling',
    'between them: Sally trapped in a cave under a tree while the boys call',
    "down to her from beside it, Sally's place the cave and each boy's the",
    'woods, however much of the page is about her. Whoever talks down to',
    'her, stays by her, or lowers a rope to her is above, in the woods,',
    'until they climb down to her; she is in the cave until she is brought',
    'out. Where each is is where they are, not where the page looks or',
    'what they talk about: "stay with her" and "I am right here with you"',
    'said from above keep them above, and where the words say where each',
    'is ("you\'re up there and I\'m down here"), they are there. On such a',
    'page give',
    'everyone present their place, one of the places named as they are; it',
    'holds from page to page until the story brings them out or back. Where',
    "everyone is in one place, each one's place is null. place is the name",
    'of where the page happens (where most of its people are),',
    ...
    'went somewhere. also is every other of the places the page moves to,',
    'in the order it goes there, where it tells of more than one (the tombs',
    'across the lake, then home to Capernaum): each one of the places, a',
    'place the text names its own; [] when the page stays in one. time is',
    '"dawn", "day", "dusk" or "night" where the',
