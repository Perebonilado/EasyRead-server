...
export const PROMPTS = {
  ...
  visualPlan: [
    [
      ...
      'that builds up as the narration goes. You are given the chapter. Say',
      'in one line what the scene teaches, name up to eight key terms in',
      "the chapter's own words, describe the one diagram in a sentence",
      '(what sits where: inputs, a centre, outputs, a sequence, a',
      'comparison side by side), name the one thing at the centre and how',
      'it is drawn: "path" when it is a real thing with a shape a student',
      'would recognise in outline (a clinic, a person, a server, a heart,',
      'a bucket, a tooth), "preset" when one of leaf, cloud, drop,',
      'document, database, capsule, sun or shield is that thing, "shape"',
      'only when the chapter is about an idea with no thing to draw; and',
      'give four to ten beats, each one',
      'sentence, in the order the scene will tell them. Every beat must be',
      'supported by the chapter; add nothing the chapter does not say.',
    ].join(' '),
    [
  ...
  visualScript: [
    [
      'You write a short visual lesson as data. A player draws it; you',
      'never write code or paths. The canvas is 360 wide by 270 high;',
      'coordinates are the centre of each element. Keep every element at',
      'least 12 units from each edge and at least 10 units apart. The',
      'picture is one composition: the thing the chapter is about at the',
      'centre, 100 to 160 units wide, drawn as a preset or as a path of',
      'its own so a student sees the thing and not a box (a rect or',
      'roundRect with a word in it is a step in a process, never the',
      'centre of a picture); what feeds it as chips on the left or top,',
      'what comes out as chips on the right or bottom, arrows attached by',
      'id from one to the other. Six to fourteen elements in all, and',
      'never more than eight on screen at once: hide or dim what the',
      'narration has finished with. Labels are one to three words; chips',
      'one or two words or a short form.',
    ].join(' '),
    [
      'Elements. label: x, y, text, size sm md lg xl, colour, anchor start',
      'middle end. chip: a rounded tag, x, y, text of up to twenty-two',
      'characters, never a word cut short, colour. shape: x, y, w, h,',
      'kind, an optional text of up',
      'to sixteen characters inside it (make w wide enough: about eight',
      'units per character plus twenty), colour, fill solid outline tint.',
      'Kinds: rect, roundRect, circle, ellipse, triangle, diamond, the',
      'presets leaf, cloud, drop, document, database, capsule, sun,',
      'shield, drawn by hand and scaled into the box, and path: the',
      "shape's own outline in d, drawn on a unit square (0 to 1 both",
      'ways) with absolute M, L, C, Q and Z commands only, at most forty',
      'of them, scaled into the box. Draw the thing the chapter is about',
      'as a path when no preset is it: a clinic, a person, a server, a',
      'tooth, a heart. Keep it simple and recognisable, one closed outline',
      'and at most a line or two inside, the way a leaf is two curves and',
      'a vein: M0 0.7 C0.11 0.13 0.73 0 1 0.33 C0.88 0.85 0.29 1 0 0.7 Z',
      'M0.04 0.67 C0.32 0.54 0.67 0.4 0.96 0.34. Give a drawn shape no',
      'text inside it; put its name in a small label beside it. line and arrow: from',
      'and to are a point {x, y} or the id of an element to attach to; an',
      'arrow may bend minus forty to forty, and may be double. icon: one',
      'of person, people, clock, book, money, heart, building, globe,',
      'gear, bulb, warning, check, question, scale, arrows, star, with x,',
      'y, size 16 to 80, colour. dots: filled circles at points, up to',
      'forty, with r. Colours: green, amber, blue, violet, orange, red,',
      'ink, muted. Every field not set is null.',
    ].join(' '),
    [
      'Narration. Three to fourteen sentences, each four to thirty words,',
      'spoken language: short sentences, no parentheses, no symbols, no',
      'markup, numbers written as they are spoken. Symbols and short forms',
      'belong in chips and labels, never in the narration. The narration',
      'says only what the chapter says.',
    ].join(' '),
    [
      'Cues. Each sentence carries up to eight cues, in word order; at is',
      'the index of the word the cue lands on, counting from zero after',
      'splitting the sentence on spaces. Actions: draw (strokes trace in),',
      'fade (appears), hide, dim, undim, pulse, flow (moving dashes along a',
      'line or arrow, until hidden), highlight (an outline), clear (target',
      '"*", hides everything). Introduce each element with draw or fade on',
      'the word where the narration first mentions it; never pulse, flow,',
      'dim or highlight an element before it is shown. Every element must',
      'be shown at least once. Every label, chip and shape text must be',
      "built from words in the chapter, the chapter's own names for",
      'things, never category names of your own, and never a word cut',
      'short or hyphenated to fit: choose a shorter word instead.',
    ].join(' '),
    [
      'Two complete lessons, the shape to aim for. The first:',
      '{"title": "How photosynthesis works", "elements": [{"id": "title", "type": "label", "x": 180, "y": 42, "text": "Photosynthesis", "size": "xl", "color": "ink"}, {"id": "leaf", "type": "shape", "x": 187, "y": 145, "w": 150, "h": 134, "kind": "leaf", "color": "green", "fill": "tint"}, {"id": "chloro", "type": "dots", "points": [{"x": 150, "y": 160}, {"x": 172, "y": 140}, {"x": 196, "y": 152}, {"x": 214, "y": 128}, {"x": 232, "y": 140}, {"x": 176, "y": 172}], "r": 5, "color": "green"}, {"id": "chloroLabel", "type": "label", "x": 188, "y": 196, "text": "chloroplasts", "size": "sm", "color": "muted"}, {"id": "sun", "type": "shape", "x": 52, "y": 62, "w": 44, "h": 44, "kind": "sun", "color": "amber", "fill": "solid"}, {"id": "lightArrow", "type": "arrow", "from": "sun", "to": "leaf", "bend": -10, "color": "amber"}, {"id": "co2", "type": "chip", "x": 306, "y": 52, "text": "CO2", "color": "violet"}, {"id": "co2Arrow", "type": "arrow", "from": "co2", "to": "leaf", "bend": 10, "color": "violet"}, {"id": "water", "type": "chip", "x": 56, "y": 228, "text": "H2O", "color": "blue"}, {"id": "waterArrow", "type": "arrow", "from": "water", "to": "leaf", "bend": -8, "color": "blue"}, {"id": "glucose", "type": "chip", "x": 300, "y": 230, "text": "glucose", "color": "orange"}, {"id": "glucoseArrow", "type": "arrow", "from": "leaf", "to": "glucose", "bend": -8, "color": "orange"}, {"id": "o2", "type": "chip", "x": 322, "y": 158, "text": "O2", "color": "blue"}, {"id": "o2Arrow", "type": "arrow", "from": "leaf", "to": "o2", "bend": -6, "color": "blue"}], "segments": [{"text": "Plants make their own food through a process called photosynthesis.", "cues": [{"at": 0, "do": "draw", "target": "leaf"}, {"at": 8, "do": "fade", "target": "title"}]}, {"text": "It happens inside the leaf, in tiny green structures called chloroplasts.", "cues": [{"at": 4, "do": "pulse", "target": "leaf"}, {"at": 7, "do": "fade", "target": "chloro"}, {"at": 10, "do": "fade", "target": "chloroLabel"}]}, {"text": "First, the leaf captures energy from sunlight.", "cues": [{"at": 0, "do": "hide", "target": "chloroLabel"}, {"at": 3, "do": "draw", "target": "sun"}, {"at": 5, "do": "draw", "target": "lightArrow"}, {"at": 6, "do": "flow", "target": "lightArrow"}]}, {"text": "Next, it pulls in carbon dioxide from the air through tiny pores.", "cues": [{"at": 4, "do": "fade", "target": "co2"}, {"at": 6, "do": "draw", "target": "co2Arrow"}, {"at": 8, "do": "flow", "target": "co2Arrow"}]}, {"text": "Water travels up from the roots to reach the leaf.", "cues": [{"at": 0, "do": "fade", "target": "water"}, {"at": 1, "do": "draw", "target": "waterArrow"}, {"at": 3, "do": "flow", "target": "waterArrow"}]}, {"text": "Using the energy of the sun, the leaf turns these ingredients into glucose, a sugar that fuels the plant.", "cues": [{"at": 4, "do": "pulse", "target": "sun"}, {"at": 7, "do": "pulse", "target": "leaf"}, {"at": 12, "do": "draw", "target": "glucoseArrow"}, {"at": 13, "do": "fade", "target": "glucose"}, {"at": 15, "do": "flow", "target": "glucoseArrow"}]}, {"text": "Oxygen is released as well, and that is the air we breathe.", "cues": [{"at": 0, "do": "draw", "target": "o2Arrow"}, {"at": 1, "do": "fade", "target": "o2"}, {"at": 2, "do": "flow", "target": "o2Arrow"}, {"at": 9, "do": "pulse", "target": "o2"}]}, {"text": "So in one line, carbon dioxide plus water plus light becomes glucose and oxygen.", "cues": [{"at": 0, "do": "hide", "target": "title"}, {"at": 4, "do": "pulse", "target": "co2"}, {"at": 7, "do": "pulse", "target": "water"}, {"at": 9, "do": "pulse", "target": "sun"}, {"at": 11, "do": "pulse", "target": "glucose"}, {"at": 13, "do": "pulse", "target": "o2"}]}]}',
      'The second:',
      '{"title": "The token bucket", "elements": [{"id": "bucket", "type": "shape", "x": 180, "y": 140, "w": 120, "h": 90, "kind": "path", "d": "M0.08 0.12 L0.92 0.12 L0.82 0.96 L0.18 0.96 Z M0.08 0.12 Q0.5 0.24 0.92 0.12", "color": "blue", "fill": "tint"}, {"id": "bucketLabel", "type": "label", "x": 180, "y": 205, "text": "bucket", "size": "sm", "color": "muted"}, {"id": "tokens", "type": "dots", "points": [{"x": 160, "y": 135}, {"x": 180, "y": 135}, {"x": 200, "y": 135}, {"x": 170, "y": 152}, {"x": 190, "y": 152}], "r": 5, "color": "amber"}, {"id": "refill", "type": "arrow", "from": {"x": 180, "y": 40}, "to": "bucket", "color": "green"}, {"id": "rate", "type": "chip", "x": 262, "y": 48, "text": "fixed rate", "color": "green"}, {"id": "request", "type": "icon", "name": "arrows", "x": 52, "y": 140, "size": 34, "color": "violet"}, {"id": "take", "type": "arrow", "from": "request", "to": "bucket", "color": "violet"}, {"id": "pass", "type": "chip", "x": 304, "y": 140, "text": "passes", "color": "green"}, {"id": "out", "type": "arrow", "from": "bucket", "to": "pass", "color": "green"}, {"id": "empty", "type": "label", "x": 180, "y": 240, "text": "empty: requests wait", "size": "md", "color": "red"}], "segments": [{"text": "A token bucket holds a small number of tokens.", "cues": [{"at": 2, "do": "draw", "target": "bucket"}, {"at": 3, "do": "fade", "target": "bucketLabel"}, {"at": 6, "do": "fade", "target": "tokens"}]}, {"text": "The bucket refills at a fixed rate, one token at a time.", "cues": [{"at": 2, "do": "draw", "target": "refill"}, {"at": 4, "do": "flow", "target": "refill"}, {"at": 6, "do": "fade", "target": "rate"}]}, {"text": "Each request that arrives takes one token out of the bucket.", "cues": [{"at": 1, "do": "fade", "target": "request"}, {"at": 4, "do": "draw", "target": "take"}, {"at": 9, "do": "pulse", "target": "bucket"}]}, {"text": "While tokens remain, the request passes at once.", "cues": [{"at": 4, "do": "draw", "target": "out"}, {"at": 5, "do": "fade", "target": "pass"}, {"at": 6, "do": "flow", "target": "out"}]}, {"text": "When the bucket is empty, requests wait for the next token or are dropped.", "cues": [{"at": 4, "do": "dim", "target": "tokens"}, {"at": 6, "do": "fade", "target": "empty"}]}, {"text": "That one rule is how a token bucket limits the rate of requests.", "cues": [{"at": 6, "do": "highlight", "target": "bucket"}]}]}',
    ].join('\n'),
    [
      'When asked to mend a script, change only what the problems name and',
