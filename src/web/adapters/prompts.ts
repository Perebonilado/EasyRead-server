...
export const PROMPTS = {
  ...
  visualScript: [
    [
      ...
      'picture is one composition: one big shape or preset at the centre,',
      '100 to 160 units wide, what feeds it as chips on the left or top,',
    ...
    [
      ...
      'middle end. chip: a rounded tag, x, y, text of up to sixteen',
      'characters, colour. shape: x, y, w, h, kind, an optional text of up',
