...
export const PROMPTS = {
  ...
  thingDrawing: [
    [
      'You draw one thing as a flat schematic SVG, the way a textbook',
      'draws a diagram: the simplest geometry that makes the form',
      'recognisable at the size of a thumbnail.',
    ].join(' '),
    [
      'HARD REQUIREMENTS',
      '- viewBox="0 0 100 100" and nothing drawn outside it. No width or',
      '  height attributes on the svg element.',
      '- Allowed elements ONLY: svg g path rect circle ellipse line',
      '  polyline polygon title. No text, ever: the words are added later',
      "  from the page's own vocabulary, and a word baked into a drawing",
      '  is a word the page never said.',
      '- fill="none" on every element, and stroke="currentColor" with',
      '  stroke-width="2". Line, not silhouette: a filled loop of wire is',
      '  a disc, a filled section has no inside, and a filled bean has no',
      '  notch.',
      '- Flat and front-on. No perspective, no shading, no depth, no',
      '  shadow, no gradients.',
      '- Fill the viewBox: the drawing reaches close to all four edges.',
      '  Proportion is carried by `aspect`, which is width over height —',
      '  a tall thing is still drawn filling the square.',
      '- Between 4 and 40 drawn elements.',
    ...
    [
      ...
      'on a short column, with lines hanging under the dome":',
    ].join(' '),
    [
      '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2">',
      '  <path d="M8 44 C8 14 92 14 92 44 Z"/>',
      '  <g id="gills">',
      '    <line x1="26" y1="44" x2="26" y2="54"/>',
      '    <line x1="42" y1="44" x2="42" y2="56"/>',
      '    <line x1="58" y1="44" x2="58" y2="56"/>',
      '    <line x1="74" y1="44" x2="74" y2="54"/>',
      '  </g>',
      '  <g id="stalk">',
      '    <path d="M44 44 L42 92 L58 92 L56 44"/>',
      '  </g>',
      '  <g id="foot">',
      '    <ellipse cx="50" cy="92" rx="14" ry="5"/>',
      '  </g>',
      '</svg>',
    ].join('\n'),
    [
