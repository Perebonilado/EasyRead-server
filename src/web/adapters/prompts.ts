...
export const PROMPTS = {
  ...
  lectureSegment: [
    ...
    [
      ...
      'Never use [pause] anywhere else. The only other bracketed marks are',
    ...
    [
      ...
      'learner and one for a quick one; then the next line. Never explain',
  ...
  lectureBoardPlan: [
    ...
    [
      ...
      'consistently, without). A list the page spells out goes on the board',
      'as its members, on one line when they fit and on two points when',
      'they do not. Write the claim itself, never a label and a colon in',
    ...
    [
      ...
      'a term is written once. A POINT for a claim, a reason, a step, an',
      'example; a point at level 2 for a detail under the point or term',
    ...
    [
      'The red line. Mark exactly ONE line on the page as important: the',
      'pitfall when the page actually shows it, otherwise the claim the',
      'page exists to make, preferring where the page says key, crucial,',
      'essential, must, the point is, minimizes or prevents. It is a claim',
      'with a verb, never a term line, never the first line of the page,',
      'never a step of a procedure. Never leave the page without one.',
    ].join(' '),
    [
  ...
  lectureBoard: [
    ...
    [
      ...
      'goes on the board as its members, on one line when they fit and on',
      'two points when they do not. Write the claim itself, never a label',
    ...
    [
      'The red line. Mark exactly ONE item on the page as important: the',
      'pitfall when the lecturer actually says it on this page, otherwise',
      'the claim the page exists to make, preferring the sentence where the',
      'lecturer says key, crucial, essential, must, the point is, minimizes',
      'or prevents. It is a claim with a verb, never a term line, never the',
      'first point of the page, never a step of a procedure, and never the',
      'closing sentence. Never mark the pitfall from the plan when it is',
      'not spoken here, and never leave the page without an important item.',
    ].join(' '),
    [
