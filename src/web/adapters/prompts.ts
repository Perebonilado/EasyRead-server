...
export const PROMPTS = {
  ...
  sceneWrite: [
    ...
    [
      ...
      'teacher talking to one person: short sentences of six to twenty-two',
      'words, everyday words, the main ideas in the order the page gives',
      ...
      'heard. Write for the ear: words, not symbols (percent, degrees), and',
      'each sentence makes sense heard alone. Point at the stage now and',
      'then ("Here is", "Watch the"). Aim for 150 to 300 spoken words; a',
      'short page gets fewer.',
    ].join(' '),
    NO_INVENTION,
    [
      'beats are the spoken sentences, one each. pause is "long" where the',
      'idea changes, else "short".',
    ].join(' '),
    [
      'cast lists every thing the stage shows. Three kinds:',
      ...
      'the proportion: wide, square or tall.',
    ...
    [
      ...
      'and moves out at the next change of stage.',
    ].join(' '),
    [
    ...
    [
      ...
      JSON.stringify({
        ...
        beats: [
          { say: 'A bicycle pump pushes air into a tyre.', pause: 'short' },
          {
