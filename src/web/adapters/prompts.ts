...
export const PROMPTS = {
  ...
  visualScript: [
    ...
    [
      'Items, four to sixteen. Each has an id, a role and a kind. Roles:',
      ...
      'the catalogue and text as the name a student reads under it; chip,',
      ...
      'chapter names, on the sides too: a sun, a tap, a nurse, a server.',
    ...
    [
      ...
      'cycle each step points to the next; a compare usually has none.',
    ].join(' '),
    [
