...
export const PROMPTS = {
  ...
  visualScript: [
    ...
    [
      ...
      'Some things have no drawing in that library: anything alive and',
      'too small to see, and much of what a science, geography or history',
      'page names. A picture card can say what shape the thing takes',
      'instead, and the app draws it. Give the card a shape with an',
      'outline, its parts, and how it moves. Outlines: blob (a soft shape',
      'that breathes, for a cell or an island), body (a smooth swimmer),',
      'branch (a trunk dividing again and again, for a river system or a',
      'nerve), layers (bands stacked up, for rock strata or the',
      'atmosphere), lattice (nodes in a mesh, for a crystal or a',
      ...
      'wind or a current). Parts: membrane, hairs, whip, core, pockets,',
      'grains, mouth, roots, joints, level, cracks, bulge. Manner: still,',
      'drift, swim, beat, stream, grow, pulse. Leave shape null for a',
      'thing the library has, such as a bus or a heart; the app knows the',
      'common shapes and reaches for them on its own.',
    ].join(' '),
    [
    ...
    [
      ...
      'for a set of things, a number or a count for a figure, a chart',
      ...
      'layers, an overlap for what two things share, a statement for the',
      'line to remember, a term when a new word appears, a hub or a',
      'compare when the page has that shape. Never two statements in a',
      'row; a title',
