  ...
  async create(
    ...
    const instructions = [
      ...
      [
        ...
        '- MAKE IT A CONVERSATION BETWEEN THEM. When one student answers,',
        '  ask a second, by name, to build on it or say where they differ,',
        '  then resolve it yourself in one line. Learning runs deepest when',
        '  they construct on each other, not when they take turns answering',
        '  you.',
        '- FEEDBACK CARRIES INFORMATION: what was right, the one thing off',
        '  and why, what to do next. Correct in the same turn. Never praise',
        '  the person; name what was right.',
