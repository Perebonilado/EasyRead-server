...
export const PROMPTS = {
  ...
  sceneSet: [
    ...
    [
      ...
      'text or signs with words. Keep the lower middle open and simple, a',
      'floor, a path, a quay, a clearing: the characters stand there. Use',
      'soft, slightly muted colours and gentle contrast, so figures in',
      'front of it stand out.',
    ].join(' '),
    [
