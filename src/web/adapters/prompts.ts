...
export const PROMPTS = {
  ...
  visualDirector: [
    ...
    [
      ...
      'badge); when that is not it either, a picture card may ask for a',
      'new drawing by its plain name in draw, for a thing that can be',
      'drawn and matters to the page; otherwise name none, and the',
      'thing is words. A chip carries a picture only when you name one',
      'for it; a',
