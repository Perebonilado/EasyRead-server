...
export const PROMPTS = {
  ...
  thingDrawing: [
    [
      'You draw labelled diagrams for a textbook — the kind a student',
      'learns from. Draw the thing you are asked for, properly, with its',
      'parts labelled, the way a good illustrated reference would show it.',
    ].join(' '),
    [
      'Get the thing right first. A kidney is bean-shaped in section with',
      'a cortex, medullary pyramids, a renal pelvis and the vessels at the',
      'hilum; a simple circuit is a closed loop of wire with a cell, a',
      'switch and a lamp in it; a volcano is a cone cut open with a crater,',
      'a conduit and a magma chamber below the ground line. Show the parts',
      'somebody learning it would need to see.',
    ].join(' '),
    [
      'HOW IT LOOKS IS YOURS. Colour, gradients, fills, shading, leader',
      'lines, a magnified inset, a caption — whatever makes it teach well.',
      'Draw it the way you would draw it at your best.',
    ].join(' '),
    [
      'THE FEW THINGS THAT ARE NOT YOURS',
      '- viewBox on the <svg>, and use the room. Fill the frame.',
      '- No <script>, <foreignObject>, <image>, <use>, <a>, <style>, no',
      '  event handlers and no links. The markup gets committed to a repo.',
      '- Put each part somebody could point at in its own <g id="name">,',
      '  three to six of them. That is what lets a lesson light one part at',
      '  a time.',
