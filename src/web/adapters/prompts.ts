...
export const PROMPTS = {
  ...
  visualScript: [
    ...
    [
      ...
      'a syringe, a factory, a river, a coin, a phone, a teacher); the app',
      'draws it from a library of about a thousand drawings of animals,',
      'buildings, people, tools, science, medicine, transport, nature,',
      'money and devices. Put a picture wherever the chapter names a',
      'thing. Colours: green, amber, blue, violet, orange, red, or null.',
    ].join(' '),
    [
