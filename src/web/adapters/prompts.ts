...
export const PROMPTS = {
  ...
  visualScript: [
    [
      ...
      'never write code or SVG. The canvas is 360 wide by 270 high;',
      'coordinates are the centre of each element. Keep every element at',
      'least 12 units from each edge and at least 10 units apart. Place',
      'elements in the regions the plan describes. Never show more than',
      'twelve elements at once: dim or hide what is no longer discussed.',
    ].join(' '),
    [
      'Elements. label: a short text (x, y, text, size sm md lg xl, colour,',
      'anchor start middle end); chip: a rounded tag of up to sixteen',
      ...
      'size 16 to 80, colour); dots: filled circles at points, up to forty.',
      'Colours are only green, amber, blue, violet, orange, red, ink,',
      'muted. Every field that is not set is null.',
    ].join(' '),
    [
    ...
    [
      ...
      'things, one to four words, never category names of your own.',
    ].join(' '),
    [
