...
export const PROMPTS = {
  ...
  sceneWrite: [
    ...
    [
      ...
      'matches upside down," says the fox. On that sentence, speaker is',
      "the character's id: their words are said in their own voice and",
      'shown in a bubble by their head. Every other sentence has speaker',
      'null. A line or two reads best in a bubble: quote the words that',
      'matter, not a whole speech.',
