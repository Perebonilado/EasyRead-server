...
export const PROMPTS = {
  ...
  sceneWrite: [
    ...
    [
      ...
      '"afraid", "surprised" or "thinking"), null for calm; change it with',
      'a show effect on "id.<face>", and point at "id.head", "id.body",',
      '"id.arms" or "id.legs". Someone real is shown as a person in the',
      'look they are known for (white hair and a moustache), never as a',
      'drawing of their face. count is how many people like them stand',
      'together: 1 for one person, or up to 4 for a group (a team, a',
      'family, a class, a crowd), drawn as a few of them, each their own',
      'person in the same clothes. People are never drawn inside a',
      '"drawing": a team on a sledge is a person with count beside a',
      'drawing of the sledge.',
      FIGURE_GUIDE,
    ...
    [
      ...
      'Fields: ref and state for character, figure, count and state for',
      'person; they are null on every other kind.',
    ].join(' '),
    [
