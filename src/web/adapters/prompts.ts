...
export const PROMPTS = {
  ...
  sceneScreenplay: [
    ...
    [
      ...
      "the narrator. Keep every line the book's characters say on this",
      ...
      'and not said aloud; "dream" in a dream or a memory. A line the book',
    ...
    [
      ...
      "place is a place's id when the scene moves there, else null; who and",
    ...
    [
      ...
      'the characters there, and a thing already in view. Someone who',
      ...
      'the words take them off it: never take someone off to show someone',
    ...
    [
      ...
      'page, a copyright notice), with fitReason saying why; else "good".',
  ...
  sceneStory: [
    ...
    'soldiers). name is what the story mostly calls',
    ...
    'text says or shows it ("they lay down to sleep": night), else null.',
