...
export const PROMPTS = {
  ...
  visualScript: [
    ...
    [
      ...
      'to four inputs and up to four outputs. Fields a card does not use',
      'are null.',
    ].join(' '),
    [
      "Words on cards are built from the chapter, in the chapter's own",
      'words: chips, items, headings, names, terms and labels up to',
      'twenty-two characters, never a word cut short. Pictures come only',
      'from the catalogue below, by name; a picture wherever the library',
      'has the thing or something close to it. Colours: green, amber,',
    ...
    [
      ...
      'figures, a list or a flow for steps, a statement for the line to',
      'remember, a term when a new word appears, a hub or a compare when',
      'the chapter has that shape. Never two statements in a row; a title',
